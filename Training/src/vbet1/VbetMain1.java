...
//        WebDriverWait wait = new WebDriverWait (driver, 10);
        driver.findElement(By.xpath("//div[contains(@class,'login-parent-div')]/label[contains(@class,'right-top')]")).click();
...
//        rightMenuIcon.click();
        ...
        driver.findElement(By.xpath("//input[contains(@name, 'login')]")).sendKeys("agafdg@adfadsf.df");
