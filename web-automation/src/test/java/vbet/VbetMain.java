...
public class VbetMain {
	...
	public void vbet() throws InterruptedException {
		...
		WebElement rightMenuIcon = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//div[contains(@class,'login-parent-div')]/label[contains(@class,'right-top')]")));

		// Enter something to search for
		rightMenuIcon.click();

		WebElement loginField = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[contains(@name, 'login')]")));
		loginField.click();
